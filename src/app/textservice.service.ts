...
export class TextService implements OnInit {
  ...
  public about: AboutText = new AboutText('Hallo mein Name ist Nicolas Eckerle. Ich bin 26 Jahre jung und ausgebildeter Mediengestalter in Digital und Print. Da ich schon immer auf der Suche nach neuen Herausforderungen war, beschloss ich nach meiner Ausbildung, nochmals meinen Horizont zu erweitern und an der Hochschule Schmalkalden zu studieren. Hier erlangte ich am 12.12.18 meinen Bachelor in Multimedia-Marketing.',
    'Im Allgemeinen würde ich mich als sehr kommunikative und teamfähige Person beschreiben, welche neuen und kreativen, sowie innovativen Lösungen aufgeschlossen gegenübersteht. Denn gerade in unserer Welt, in der die Digitalisierung eine immer wichtigere Rolle einnimmt, ist es umso wichtiger neue Trends und technische Entwicklungen frühzeitig zu erkennen, um stehts optimale und moderne Problemlösungen anbieten zu können.',);
  public text: Text = new Text('Nach dem man überall diese Rivertables sieht, dachte ich mir, das muss ich auch mal ausprobieren. Gesagt getan Resin gekauft und mangels von passendem Werkzeug, einfach mit einer Handsäge Brennholz Manuel auf 4 cm Höhe gesägt, anschließend mit gefärbten Epoxy aufgefüllt und mit LEDs ausgestattet.',
